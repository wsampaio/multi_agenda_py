...
if form:
	if form.getvalue("codReceita") != None:
		codReceita = int(form.getvalue("codReceita"))
	
	if form.getvalue("codContaPagadora") != None:
		codContaPagadora = int(form.getvalue("codContaPagadora"))
...
if codReceita > 0:
	lista = contaDAO.listaPelaReceita(codReceita)

if codContaPagadora > 0:
